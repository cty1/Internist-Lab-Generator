...
<body>
    ...
    <div id=c ontent>
        <ul id="inputs">
            ...
            <li>
                <input type="number" id="heightFt">Feet
                <input type="number" id="heightIn">Inches</li>
            <li>Patient Weight:
                <input type="number" id="weight">lbs</li>
            <li>Patient Blood Pressure:
                <input type="text" id="pressure">
            </li>
            <li>Patient Pulse:
                <input type="text" id="pulse">
            </li>
            <li>Patient Temperature:
                <input type="number" id="temperature">°F</li>
            ...
            <label class="radio">
                <input type="radio" name="urineStatus" value="yes" onclick="urinalysis()">Yes
                <br>
                <span class="checkdot"></span>
            </label>
            <label class="radio">
                <input type="radio" name="urineStatus" value="no" onclick="urinalysis()">No
                <br>
                <span class="checkdot"></span>
            </label>
            <label class="radio">
                <input type="radio" name="urineStatus" value="notApplicable" onclick="urinalysis()">N/A
                <br>
                <span class="checkdot"></span>
            </label>
            <li id="urineQuestions"></li>
            <li>What was the year of the last visit?
                <input type="text" id="yearLast">
            </li>
            <li>What was the total cholesterol last visit?
                <input type="text" id="cholLast">
            </li>
            <li>What was the total cholesterol this visit?
                <input type="text" id="cholThis">
            </li>
            <li>What was the triglycerides last visit?
                <input type="text" id="triLast">
            </li>
            <li>What was the triglycerides this visit?
                <input type="text" id="triThis">
            </li>
            <li>What was the HDL last visit?
                <input type="text" id="hdlLast">
            </li>
            <li>What was the HDL this visit?
                <input type="text" id="hdlThis">
            </li>
            <li>What was the LDL last visit?
                <input type="text" id="ldlLast">
            </li>
            <li>What was the LDL this visit?
                <input type="text" id="ldlThis">
            </li>
            ...
            <li>
                <label class="radio">
                    <input type="radio" name="crpStatus" value="yes">Yes
                    <br>
                    <span class="checkdot"></span>
                </label>
                <label class="radio">
                    <input type="radio" name="crpStatus" value="no">No
                    <br>
                    <span class="checkdot"></span>
                </label>
                <label class="radio">
                    <input type="radio" name="crpStatus" value="notApplicable">N/A
                    <br>
                    <span class="checkdot"></span>
                </label>
            </li>
            <li>What was the vitamin D?
                <input type="number" id="vitD">
            </li>
            <li>What was the vitamin B12?
                <input type="number" id="vitB12">
            </li>
            <li>Did the sedimentation rate show any sign of inflamation?</li>
            <li>
                <label class="radio">
                    <input type="radio" name="sedStatus" value="yes">Yes
                    <br>
                    <span class="checkdot"></span>
                </label>
                <label class="radio">
                    <input type="radio" name="sedStatus" value="no">No
                    <br>
                    <span class="checkdot"></span>
                </label>
                <label class="radio">
                    <input type="radio" name="sedStatus" value="notApplicable">N/A
                    <br>
                    <span class="checkdot"></span>
                </label>
            </li>
            ...
            <li>
                <label class="radio">
                    <input type="radio" name="tshStatus" value="normal" onclick="tshNormal()">Normal
                    <br>
                    <span class="checkdot"></span>
                </label>
                <label class="radio">
                    <input type="radio" name="tshStatus" value="elevated" onclick="tshQuestion()">Elevated
                    <br>
                    <span class="checkdot"></span>
                </label>
                <label class="radio">
                    <input type="radio" name="tshStatus" value="suppressed" onclick="tshQuestion()">Suppressed
                    <br>
                    <span class="checkdot"></span>
                </label>
            </li>
            <li id="tshPopup"></li>
            <li>What was the Hemoglobin A1C?
                <input type="number" id="hemoA1C">%</li>
            ...
            <li>What was the ECG rate?
                <input type="number" id="ecgRate">
            </li>
        </ul>
